...
Page({
  ...
  gotoOrder: function (e) {
    ...
    if (typeof (merchant_id) == 'undefined') {
      ...
      wx.navigateTo({
        url: '/pages/hotel/order/index?merchant_id=' + merchant_id + '&openid=' + openid + '&order_status=0',
      })
    }
   ...
   */
  addDishes: function (e) {
    console.log('/pages/hotel/dishes/add_dishes?merchant_id=' + merchant_id + "&openid=" + openid)
    wx.navigateTo({
      url: '/pages/hotel/dishes/add_dishes?merchant_id=' + merchant_id + "&openid=" + openid,
    })
  },
